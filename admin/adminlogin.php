...
<body>
    ...
    if (isset($_SESSION['email'])) {
        ...
        if (isset($email) && isset($password)) {
            ...
            $sql = "SELECT email, passwords FROM admin WHERE email='$email' AND passwords='$password'";
    ...
    <form id="login-form-container" name="loginForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validateForm();">
        ...
        <input type="email" name="email" class="loginform-input" placeholder="abinaayan@gmail.com"> <br>

        <label class="loginform-label">Password</label><br>
        <input type="password" name="password" class="loginform-input" placeholder="0740217952"> <br>
